...
" Do something in visual mode
function! s:VSCodeNotifyInVisual(cmd, leaveSelection, ...)
    normal! gv
...
"VS Code folding
map ztf :call VSCodeNotify('editor.toggleFold')<CR>
map zfo :call VSCodeNotify('editor.foldAll')<CR>
map zuf :call VSCodeNotify('editor.unfoldAll')<CR>
map zgp :call VSCodeNotify('editor.gotoParentFold')<CR>
map zj :call VSCodeNotify('editor.gotoNextFold')<CR>
map zk :call VSCodeNotify('editor.gotoPreviousFold')<CR>

"VS Code commenting out code lines and code blocks
xmap gm  <Plug>VSCodeCommentary
nmap gm  <Plug>VSCodeCommentary
omap gm  <Plug>VSCodeCommentary
nmap gc <Plug>VSCodeCommentaryLine
map <silent> gb <ESC><Cmd>call <SID>VSCodeNotifyInVisual('editor.action.blockComment', 1)<CR><ESC>
